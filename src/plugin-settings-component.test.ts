...
describe('PluginSettingsComponent', () => {
  ...
  describe('registerLegacySettingsConverters', () => {
    it('should register a single converter whose legacy class defaults shouldUpdateLinks to true', () => {
      registerConverters();
      ...
      expect(new legacySettingsClass().shouldUpdateLinks).toBe(true);
    });

    it('should carry a legacy shouldUpdateLinks over into proposedShouldHandleRenames', () => {
      registerConverters();
      const record: GenericObject = { shouldUpdateLinks: false };
